...
const InterviewComplete: React.FC<InterviewCompleteProps> = ({ interviewId }) => {
    ...
    useEffect(() => {
        ...
        pollIntervalRef.current = setInterval(fetchFeedback, 5000);
            ...
            <Container maxWidth="sm" sx={{ py: 8, textAlign: 'center' }}>
                ...
                >
                    ...
                    <Typography variant="body2" color="text.secondary">
                        This usually takes 1–2 minutes. We'll show your results as soon as they're ready.
                    </Typography>
                </Card>
    ...
    if (error) {
        return (
            <Container maxWidth="sm" sx={{ py: 8 }}>
                ...
                <Button variant="outlined" startIcon={<Replay />} onClick={fetchFeedback}>
                    Retry
                </Button>
            </Container>
        );
    ...
    return (
        <Container maxWidth="md" sx={{ py: 4 }}>
            ...
            <Accordion
                defaultExpanded
                elevation={0}
                sx={{ mb: 2, borderRadius: '12px !important', border: '1px solid', borderColor: 'divider', '&:before': { display: 'none' } }}
            >
            ...
            <Accordion
                defaultExpanded
                elevation={0}
                sx={{ mb: 3, borderRadius: '12px !important', border: '1px solid', borderColor: 'divider', '&:before': { display: 'none' } }}
            >
                <AccordionSummary expandIcon={<ExpandMore />}>
